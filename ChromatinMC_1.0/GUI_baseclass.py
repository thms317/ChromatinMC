...
class ControlFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText19 = wx.StaticText( self, wx.ID_ANY, u"Number of ribbons", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText19.Wrap( -1 )
		fgSizer4.Add( self.m_staticText19, 0, wx.ALL, 5 )
		
		self.m_textRibs = wx.TextCtrl( self, wx.ID_ANY, u"1", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_textRibs, 0, wx.ALL, 5 )
		
		self.m_staticText20 = wx.StaticText( self, wx.ID_ANY, u"Fiber diameter", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText20.Wrap( -1 )
		fgSizer4.Add( self.m_staticText20, 0, wx.ALL, 5 )
		
		self.m_textDiameter = wx.TextCtrl( self, wx.ID_ANY, u"330", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_textDiameter, 0, wx.ALL, 5 )
		
		self.m_staticText21 = wx.StaticText( self, wx.ID_ANY, u"Fiber rise", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText21.Wrap( -1 )
		fgSizer4.Add( self.m_staticText21, 0, wx.ALL, 5 )
		
		self.m_textFiberRise = wx.TextCtrl( self, wx.ID_ANY, u"100", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_textFiberRise, 0, wx.ALL, 5 )
		
		self.m_staticText24 = wx.StaticText( self, wx.ID_ANY, u"Stack", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText24.Wrap( -1 )
		fgSizer4.Add( self.m_staticText24, 0, wx.ALL, 5 )
		
		self.m_checkStack = wx.CheckBox( self, wx.ID_ANY, u"Yes", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_checkStack, 0, wx.ALL, 5 )
		
		self.m_staticText23 = wx.StaticText( self, wx.ID_ANY, u"Fiber twist", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText23.Wrap( -1 )
		fgSizer4.Add( self.m_staticText23, 0, wx.ALL, 5 )
		
		self.m_textFiberTwist = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_textFiberTwist, 0, wx.ALL, 5 )
		
		self.m_staticText22 = wx.StaticText( self, wx.ID_ANY, u"Fiber NLD", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText22.Wrap( -1 )
		fgSizer4.Add( self.m_staticText22, 0, wx.ALL, 5 )
		
		self.m_textNLD = wx.TextCtrl( self, wx.ID_ANY, u"17", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_textNLD, 0, wx.ALL, 5 )
